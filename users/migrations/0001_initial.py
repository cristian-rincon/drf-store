# Generated by Django 3.1.1 on 2020-09-22 02:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_client', models.BooleanField(default=True, help_text='Help to distinguish users and perform queries', verbose_name='client status')),
                ('is_verified', models.BooleanField(default=True, help_text='Set to tue when the user have verified its email address.', verbose_name='verified')),
